...
- Add Android Kotlin runtime/bridge, QuickJS/Zig candidate host, Haptics module, release build smoke, and emulator instrumentation CI.
- Preserve the original browser game-engine implementation on `archive/game-engine-v0.1`.

Release remains blocked until ADR 0004 is accepted from checked-in release-build physical-device evidence for the surviving Sting runtime candidates and React Native/Hermes baseline on iOS and Android.
