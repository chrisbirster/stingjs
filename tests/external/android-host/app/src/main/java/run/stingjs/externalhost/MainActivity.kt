package run.stingjs.externalhost
...
/**
 * Standalone consumer of the prebuilt Sting Android host artifacts.
 *
 * This source intentionally has no repository-relative source dependency and
 * no module registrations. It proves that the native renderer + production
 * QuickJS host can be consumed as ordinary AAR inputs.
 */
